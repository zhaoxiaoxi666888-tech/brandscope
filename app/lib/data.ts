...
export type BriefDTO = { id: string; background: string; marketingObjective: string; positioning: string; persona: string; coreInsights: string; communication: string; contentSuggestions: string; channels: string; kpis: string; markdown: string; updatedAt: string };
