...
- 将公开 Benchmark 更新为 Oura 美国、Whoop 美国与 Ultrahuman 印度，覆盖三种可穿戴产品与 GTM 场景。
- 为只读 Benchmark 增加 GTM 路线、竞品矩阵、用户旅程、海外渠道、KOL、本地化、指标、单位经济、增长实验和访谈验证展示。
- 24 条版本化 Evidence URL 完成在线可访问性检查；移除预览版本中的占位和失效来源。
- 保持私人真实研究的 PostgreSQL Schema 与九章节 Brief 不变，避免未经迁移的字段影响生产稳定性。
- 更新 Benchmark 文档与演示脚本，明确策略数字、来源事实和模型推断仍需人工核验。
